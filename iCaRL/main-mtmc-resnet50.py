...
num_epochs = 1
lr = 1e-5
# Specify the outputfilename
accuracy_csv, aucroc_csv = 'MTMCRResultsAccuracyResNet50.csv', 'MTMCResultsROCAUCResNet50.csv'
####################################################################################
...
# Instantiate Model
mtmc_model = MTMCiCaRLModel(model_state_dict, 'resnet50', total_memory=1000, feature_size=2048)

if os.path.exists(real_exemplars_resnet50) and os.path.exists(gan_exemplars_resnet50):
